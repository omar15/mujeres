...
jQuery.validator.addMethod("exactlength", function(value, element, param) {
 ...
 return this.optional(element) || value.length == param;
    ...
    $('#mod_pys').click(function() {
        ...
        window.location.href = '../../productos_servicios/reg_pys_beneficiario/lista_beneficiario_pys.php';
    ...
    $('#mod_beneficiario').click(function() {
        ...
        window.location.href = '../../beneficiario/registro/lista_beneficiario.php';
