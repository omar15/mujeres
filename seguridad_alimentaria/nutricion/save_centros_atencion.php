...
//Validamos si editaremos o no
 if($id_edicion > 0){
    ...
    //Tipo de archivo
    $tipo = 'edita_centros_atencion';        

    //Editamos registro
    $resp = Centros_atencion::saveCentros_atencion($_POST,$id_edicion);

    }else{
        
    //Creamos registro        
     $resp = Centros_atencion::saveCentros_atencion($_POST);    
    }
